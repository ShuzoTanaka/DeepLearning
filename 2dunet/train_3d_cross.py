...
class Nifti3DDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        mask_tensor = torch.from_numpy(nerve_mask)  # float32 (0 or 1)
...
def main():
    ...
    parser.add_argument(
        "--cv",
        action="store_true",
        help="images / labels フォルダから K-fold 交差検証を行う",
    )
    parser.add_argument(
        "--num_folds",
        type=int,
    ...
    # ======================================================
    # CV モード: Dataset/images & Dataset/labels を K-fold
    # ======================================================
    if args.cv:
        ...
        for fold_idx, val_idx in enumerate(folds):
            ...
            # fold 毎の評価（val set をその fold の test とみなす）
